module.exports = {
    censorship: /хуй|хуи|хуе|хуё|хуя|пизд|пезд|пёзд|ебл|ёбл|ёбел|ебел|еба|ебо|еби|ёба|ёбо|ёби|муд|блят|бляд|ганд|сук|суч|мраз/,
    ...
    ignore: /^игнор/,
    sword: /^не матерись|^цензур/,
    trolling: /^\+семпл|^семпл|^\+фраза|^фраза/i,
    stopTrolling: /^перестать троллить$|^не троллить$|^хватит$/,
    botMem: /^бот,? запомни |^бот,? фраза |^бот,? повторяй /i,
    botForgot: /^бот,? забудь|^бот,? не повторяй/
}